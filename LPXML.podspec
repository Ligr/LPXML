...
Pod::Spec.new do |s|
  s.name             = "LPXML"
  s.version          = "0.1.0"
  s.summary          = "A short description of LPXML."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/LPXML"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Alex" => "aliaksandr.huryn@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/LPXML.git", :tag => s.version.to_s }
